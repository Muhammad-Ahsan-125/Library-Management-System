...
{
    users.push_back(new Librarian("admin", "admin", "Main", "Librarian"));  //Hardcoded librarian Credentials To Login
    loadUsers();
...
void LibraryManagementSystem::registerUser()
{
    ...
    bool alreadyexist;  //To avoid duplication
    bool isValid;  
    ...
    do
    {
        ...
        cout << "Seat number (XX-XXXXX): ";    // Username Format Validation
        getline(cin, seatno);
